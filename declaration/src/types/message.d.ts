...
export declare type Message = AtMessage | AppMessage | XmlMessage | DiceMessage | FaceMessage | FileMessage | JsonMessage | PokeMessage | AtAllMessage | ImageMessage | PlainMessage | QuoteMessage | VoiceMessage | SourceMessage | ForwardMessage | MiraiCodeMessage | FlashImageMessage | MusicShareMessage;
export declare type MessageChain = Message[];
...
export declare type RecvMessageChain = FriendMessageChain | StrangerMessageChain | GroupMessageChain | TempMessageChain | OtherClientMessageChain;
...
declare type PicMessage = Partial<{
    imageId: string;
    url: string;
    path: string;
    base64: string;
