...
type FriendEvents = FriendInputStatusChangedEvent | FriendNickChangedEvent;
...
export interface GroupEntranceAnnouncementChangeEvent
  extends GroupDataChangeEvent<string> {
...
export interface GroupAllowAnonymousChatEvent
  extends GroupDataChangeEvent<boolean> {
...
type MessageEvents = GroupRecallEvent | FriendRecallEvent | NudgeEvent;
...
type OtherClientEvents = OtherClientOnlineEvent | OtherClientOfflineEvent;
